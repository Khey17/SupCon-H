...
def train(net, data_loader, train_optimizer, temperature, estimator, beta, gradient_imp, batch_size):
    net.train()
...
if __name__ == '__main__':
    ...
    for epoch in range(1, epochs + 1):
        train_loss = train(model, train_loader, optimizer, temperature, estimator, beta, gradient_imp, batch_size)
