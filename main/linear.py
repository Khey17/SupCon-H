...
if __name__ == '__main__':
    ...
    parser.add_argument('--dataset_name', default='ferplus', type=str, help='Choose loss function')

    args = parser.parse_args()
    model_path, batch_size, epochs = args.model_path, args.batch_size, args.epochs
    dataset_name = args.dataset_name
    
    train_data, _, test_data = utils_2.get_dataset(dataset_name, root=args.root, pair=False)
